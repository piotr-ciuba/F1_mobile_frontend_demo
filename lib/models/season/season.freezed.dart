...
abstract class $SeasonCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? season, String? url});
}
...
class _$SeasonImpl implements _Season {
  _$SeasonImpl({this.season, this.url});
  ...
  @override
  String toString() {
    return 'Season(season: $season, url: $url)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, season, url);
...
abstract class _Season implements Season {
  factory _Season({final String? season, final String? url}) = _$SeasonImpl;
